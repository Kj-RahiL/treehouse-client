...
const ProductBanner = () => {
  return (
    <div className="hero relative max-h-[400px] " >
      ...
      <div className=" absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 text-white text-center py-10">
        <h1 className="text-xl md:text-2xl lg:text-5xl font-bold text-[#eefcf2] glassMor px-6 py-3">
        Our Products
        </h1>
      </div>
    </div>
